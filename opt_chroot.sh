...
#sudo chroot /opt/fewch su $USER -c "yay -S steam steam-native-runtime krita wps-office ttf-wps-fonts wps-office-extension-french-dictionary namebench komodo-edit"
#sed "s/TODO/$(awk -v val=1000 -F ':' '$3==val{print $1}' /etc/passwd)/" schroot.conf 
#sudo cp schroot.conf /etc/schroot/schroot.conf
#sudo cp schroot_wrapper /usr/bin/schroot_wrapper
